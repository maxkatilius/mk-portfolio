    ...
    return (
        <section
            ...
            className="
                ...
                min-h-[calc(100vh-5rem)] sm:h-full flex flex-col justify-between gap-12 sm:gap-14 lg:gap-18 xl:gap-14 
        ...
        ">
            ...
            <div className="flex flex-col items-center gap-6 text-[0.95rem] sm:text-[1.05rem] md:text-[1.1rem] lg:text-[1.2rem] xl:text-[1.35rem]">
                <p>
            ...
            <div className="flex flex-col md:items-center gap-4 sm:text-[1.1rem] md:text-[1.2rem] lg:text-[1.25rem] xl:text-[1.5rem]">
